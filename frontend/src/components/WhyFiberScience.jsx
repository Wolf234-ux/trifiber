...
export default function WhyFiberScience({ setActiveTab }) {
  return (
    <div className="py-12 lg:py-16 bg-[#f5ead8] space-y-16">
      ...
      <div className="container-max text-left">
        <div className="bg-[#201e1d] text-[#f5ead8] rounded-[36px] p-10 md:p-14 space-y-6 shadow-xl">
          <span className="tag tag-accent text-xs font-mono font-bold">Clinical Perspective</span>
          ...
          <p className="text-[#f5ead8]/80 text-base max-w-3xl leading-relaxed font-sans">
          ...
          <div className="pt-4 flex flex-wrap gap-4">
            ...
            <button
              ...
              className="btn btn-secondary !border-[#f5ead8]/30 !text-[#f5ead8] hover:!bg-[#f5ead8]/10 px-7 py-3.5"
            >
